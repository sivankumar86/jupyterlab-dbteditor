...
export class DbtDocModel implements DocumentRegistry.IModel {
   ...
   */
    readonly sharedModel: DbtDoc = DbtDoc.create();
  ...
  fromString(data: string): void {
    this.sharedModel.transact(() => {
      this.sharedModel.set('content', data);
    });
 }
  ...
  // ): void => {
  //   console.log("change shared model")
 ...
 * for the widget.
 */
export type DbtDocChange = {
    contentChange?: string;
  } & DocumentChange;

export class DbtDoc extends  YDocument<DbtDocChange> {
